...
private:
    ...
    string GetName(const map<int, string>& name_years, int year) const {
    ...
    string GetAllNames(const map<int, string>& name_years, int year) const {
    ...
    string PrepareFullNameToPrint(const string& first_name, const string& last_name) const {
